...
dts duckiebot update [your_robot_name]</code></pre>
  ...
  <li>
    ...
    Then, copy our files here for  <a href="visual_servoing_activity.py">lane following </a> and  <a href="https://github.com/mimichen123/dgmd-e17/object-detection"> object detection</a>  to the module folder in your repository. This step ensures this implementation is correctly integrated into the Duckietown autonomy stack.
  </li><br>
